...
void UTP_WeaponComponent::PlayAnimation()
{
	NetMC_PlayAnimation();
}

void UTP_WeaponComponent::NetMC_PlaySound_Implementation()
{
...
void UTP_WeaponComponent::NetMC_PlayAnimation_Implementation()
{
...
void UTP_WeaponComponent::AttachWeapon(AFPSCharacterUE5Character* TargetCharacter)
{
