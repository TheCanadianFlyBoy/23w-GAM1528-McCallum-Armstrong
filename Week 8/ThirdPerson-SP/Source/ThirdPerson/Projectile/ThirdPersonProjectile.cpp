...
AThirdPersonProjectile::AThirdPersonProjectile()
{
	...
	static ConstructorHelpers::FObjectFinder<USoundBase> DefaultExplosionSound(TEXT("/Game/StarterContent/Audio/Explosion01.Explosion01"));
	if (DefaultExplosionSound.Succeeded())
	{
		ExplosionSound = DefaultExplosionSound.Object;
	}
...
//NETWORK ??
void AThirdPersonProjectile::NMC_PlayEffects_Implementation()
{
