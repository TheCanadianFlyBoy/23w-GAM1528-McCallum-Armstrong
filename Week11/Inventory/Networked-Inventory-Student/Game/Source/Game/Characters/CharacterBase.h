...
public:
	...
	//TODO: 1 NET CODE 2 SHOOTING -- CAN LEAVE THIS FOR LATER
	//TODO: WEEK8
	...
	//MAKE THIS A SERVER FUNCTION
		void Server_NextInventoryItem();

	//MAKE THIS A SERVER FUNCTION
		void Server_PrevInventoryItem();

	UFUNCTION()
		void InteractDropWeapon();

	void NoWeapon(bool discard);

	//MAKE THIS A SERVER FUNCTION
		void Server_Pickup(class AItemBase* PickedItem);
	...
	class UMaterial* CursorDecalMaterial;

	class AItemBase* LastSelectedItem;
	/*For Pickups*/
	//	UFUNCTION()
